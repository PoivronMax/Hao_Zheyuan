...
int main(void)
{
    ...
    while (1) {
        ...
        bool right_obstacle = Prox_Value[0] > 350 || Prox_Value[1] > 350 || Prox_Value[2] > 350; //right obstacle
        bool left_obstacle = Prox_Value[5] > 350 || Prox_Value[6] > 350 || Prox_Value[7] > 350;  // left obstacle
